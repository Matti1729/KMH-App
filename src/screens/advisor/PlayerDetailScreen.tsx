...
const styles = StyleSheet.create({
  ...
  playerFirstName: { fontSize: 18, color: '#666' },
  playerLastName: { fontSize: 24, fontWeight: 'bold', color: '#000' },
  ageRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  ageText: { fontSize: 12, color: '#666' },
  ...
  clubLogoHeader: { width: 60, height: 60, resizeMode: 'contain', marginBottom: 6 },
  clubNameHeaderNoLogo: { fontSize: 11, fontWeight: '600', textAlign: 'center', maxWidth: 100 },
  ...
  documentList: { marginTop: 6 },
  documentItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f8f8f8', padding: 6, borderRadius: 6, marginBottom: 4 },
  documentLink: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  documentIcon: { fontSize: 14, marginRight: 6 },
  documentName: { fontSize: 11, color: '#333' },
  ...
  mobileMenuItem: { paddingVertical: 10, paddingHorizontal: 12, borderBottomWidth: 1, borderBottomColor: '#333' },
  mobileMenuItemText: { color: '#fff', fontSize: 11 },
