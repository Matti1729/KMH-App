...
const styles = StyleSheet.create({
  ...
  kanbanTitle: { fontSize: 11, fontWeight: '600', color: '#475569', flex: 1 },
  ...
  cardInfo: { flex: 1 },
  playerName: { fontSize: 11, fontWeight: '600', color: '#1a1a1a' },
  ...
  modalSubtitle: { fontSize: 11, color: '#64748b', marginBottom: 20 },
  archiveConfirmButton: { paddingVertical: 6, paddingHorizontal: 10, borderRadius: 6, backgroundColor: '#ef4444' },
  archiveConfirmButtonText: { fontSize: 11, color: '#fff', fontWeight: '600' },
  ...
  notesPlayerName: { fontSize: 11, color: '#64748b', marginBottom: 12 },
  // Player Edit Modal
