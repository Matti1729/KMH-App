    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Spieler-Übersicht</Text>
          <Text style={styles.cardText}>Hier sehen Sie alle registrierten Spieler</Text>
          <Text style={styles.emptyText}>Noch keine Spieler registriert</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Scouting</Text>
          <Text style={styles.cardText}>Ihre Scouting-Liste</Text>
          <Text style={styles.emptyText}>Noch keine Spieler im Scouting</Text>
        </View>
